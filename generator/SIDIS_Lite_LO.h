...
class SIDIS
{
 ...
 /*       void SetLHAPDF(){*/
        ...
        int CalcXS(){
            ...
            //cout << "TEST OF fF2p in beginning of CalcXS(). Value is " << fF2p << endl;
            //cout << "TEST OF fF2n in beginning of CalcXS(). Value is " << fF2n << endl;
          ...
          //  cout << "TEST OF fXS_Inclusive  in beginning of CalcXS(). Value is " << fXS_Inclusive << endl;
          ...
          //  cout << "TEST OF fF2p in end of CalcXS(). Value is " << fF2p << endl;
          //  cout << "TEST OF fF2n in end of CalcXS(). Value is " << fF2n << endl;
          //  cout << "TEST OF fXS_Inclusive  in end of CalcXS(). Value is " << fXS_Inclusive << endl;
          //  cout << "END OF CALCXS FUNCTION" <<endl;
