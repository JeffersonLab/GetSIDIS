...
void get_rate(){
    ...
    TString cut_pip = Form("(weight_hp*%f) * (x>0.008&&x<0.012)", Lumi*nBcm2*one_day);
    TString cut_pim = Form("(weight_hm*%f) * (x>0.008&&x<0.012)", Lumi*nBcm2*one_day );
    TString cut_diff= Form("(weight_hp-weight_hm)*%f * (x>0.008&&x<0.012)", Lumi*nBcm2*one_day);
    ...
    for(int i=0;i<10;i++){
        for(int j=1;j<=4;j++)
            T0->Add(Form("EIC_A12_pion_10_600_%d_%d.root", j, i));
    }

    TCanvas *c1 = new TCanvas("c1","c1", 800, 600);
    TH2D *h1 = new TH2D("h1","^{12}C(e,e'#pi^{+})X, E_{e}=10GeV, E_{A}=600GeV, Count in 1-day (0.008<x<0.012); z (GeV); log(Q^{2}) (GeV^{2}))", 7, 0.15, 0.85,8, 0.0, 1.6);
    ...
    TH2D *h3 = new TH2D("h3","^{12}C(e,e'#pi^{-})X, E_{e}=10GeV, E_{A}=600GeV, Count in 1-day (0.008<x<0.012); z (GeV); log(Q^{2}) (GeV^{2}))", 7, 0.15, 0.85,8, 0.0, 1.6);
    ...
    TH2D *h5 = new TH2D("h5","^{12}C:e,e'#pi^{-})X, E_{e}=10GeV, E_{A}=600GeV, Count-Diff(#pi^{+})-R(#pi^{-}) in 1-day, (0.008<x<0.012); z (GeV); log(Q^{2}) (GeV^{2}))", 7, 0.15, 0.85,8, 0.0, 1.6);
