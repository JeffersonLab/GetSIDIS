...
//	const double dilute_factor = 0.85; //85% overall efficiency,1/3 for He3 
	...
	const double Asys = 0.005; //FIX_HERE, for Collins asymmetry, 1/sqrt(N), from Min's EIC code
	const double Nsys = 4e+4; //FIX_HERE, for Collins asymmetry, 1/sqrt(N),from Min's SoLID code
