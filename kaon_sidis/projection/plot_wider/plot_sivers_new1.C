...
void plot_new(){
	...
	TLegend *l1 = new TLegend(0.5,0.76,0.89,0.94);
	Float_t x=0.,y=0.;
	...
	c1->Print("SoLID_pip_sivers.pdf");
	c1->Print("SoLID_pip_sivers.png");
	c2->Print("SoLID_pim_sivers.pdf");
	c2->Print("SoLID_pim_sivers.png");
}
